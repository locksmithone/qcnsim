 ...
 */
std::shared_ptr<Entity> TrafficGenerator::getTokenContents() {
 ...
 * @return EventType.
 */
EventType TrafficGenerator::getEventType() {
	return eventType;
}
 ...
 */
std::shared_ptr<Entity> TrafficGenerator::getSource() {
	return source;
}
 ...
 */
std::shared_ptr<Entity> TrafficGenerator::getDestination() {
	return destination;
}
 ...
 */
unsigned int TrafficGenerator::getTokensGeneratedCount() {
