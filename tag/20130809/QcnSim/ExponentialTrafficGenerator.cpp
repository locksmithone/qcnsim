 ...
 * Also constructs the exponential variate generator.
 * 
 ...
 * @param tau Mean interarrival time for exponential probability distribution.
 */
 ...
 * @return Tau.
 */
double ExponentialTrafficGenerator::getTau() {
	return tau;
}
