...
public:
	...
	virtual unsigned int getTokensGeneratedCount();
	virtual EventType getEventType();
	virtual void setEventType(EventType eventType);
	virtual std::shared_ptr<Entity> getTokenContents();
	virtual std::shared_ptr<Entity> getSource();
	virtual void setSource(std::shared_ptr<Entity> source);
	virtual std::shared_ptr<Entity> getDestination();
