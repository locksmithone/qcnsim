...
#include "../QcnSim/WeibullTrafficGenerator.h"
...
/// Fixture for WeibullTrafficGenerator classes Tests.
class WeibullTrafficGeneratorTest: public ::testing::Test {
protected:
