...
protected:
	...
	virtual std::shared_ptr<Token> createInstanceTrafficEvent() =0; // Pure virtual, must be implemented by child classes.
	virtual std::shared_ptr<Token> createInstanceTrafficEvent(std::shared_ptr<Entity> tokenContents) =0; // Pure virtual, must be implemented by child classes.
	virtual std::shared_ptr<Token> createInstanceTrafficEvent(std::vector<std::shared_ptr<Entity>> explicitRoute) =0; // Pure virtual, must be implemented by child classes.
	virtual std::shared_ptr<Token> createInstanceTrafficEvent(std::shared_ptr<Entity> tokenContents, std::vector<std::shared_ptr<Entity>> explicitRoute) =0; // Pure virtual, must be implemented by child classes.
