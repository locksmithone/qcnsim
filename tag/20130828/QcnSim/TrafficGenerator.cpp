 ...
 */
std::shared_ptr<Token> TrafficGenerator::createInstanceTrafficEvent() {
	// Creates a token and assigns it class member values and a unique ID obtained from simulatorGlobals.
	if (isOn) {
		std::shared_ptr<Token> token(new Token(simulatorGlobals, this->priority, this->tokenContents, this->source, this->destination));
 ...
 * @return Token that was generated, per the class constructor parameters, and if generator is On. Otherwise, returns NULL.
 */
std::shared_ptr<Token> TrafficGenerator::createInstanceTrafficEvent(std::shared_ptr<Entity> tokenContents) {
	...
	if (isOn) {
		std::shared_ptr<Token> token(new Token(simulatorGlobals, this->priority, tokenContents, this->source, this->destination));
		++tokensGeneratedCount; // One more token generated.
		return token;
	} else {
		return NULL;
 ...
 * @return Token that was generated, per the class constructor parameters and if generator is On. Otherwise, returns NULL.
 */
std::shared_ptr<Token> TrafficGenerator::createInstanceTrafficEvent(std::vector<std::shared_ptr<Entity>> explicitRoute) {
	// Creates a token and assigns it class member values and a unique ID obtained from simulatorGlobals.
	if (isOn) {
		std::shared_ptr<Token> token(new Token(simulatorGlobals, this->priority, this->tokenContents, this->source, this->destination, explicitRoute));
		++tokensGeneratedCount; // One more token generated.
		return token;
	} else {
		return NULL;
 ...
 * @return Token that was generated, per the class constructor parameters, and if generator is On. Otherwise, returns NULL.
 */
std::shared_ptr<Token> TrafficGenerator::createInstanceTrafficEvent(std::shared_ptr<Entity> tokenContents, std::vector<std::shared_ptr<Entity>> explicitRoute) {
	// Creates a token and assigns it class member values and a unique ID obtained from simulatorGlobals. Use tokenContents from parameters.
	if (isOn) {
		std::shared_ptr<Token> token(new Token(simulatorGlobals, this->priority, tokenContents, this->source, this->destination, explicitRoute));
		++tokensGeneratedCount; // One more token generated.
		return token;
	} else {
		return NULL;
