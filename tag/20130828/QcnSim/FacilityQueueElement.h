 ...
 * I.e., a facility has a priority queue. The priority queue has elements, typically tokens.
 * The element is a token and a serviceTime for this token.
...
public:
	...
	/// Comparator
	friend bool FacilityQueueElement::operator<(const FacilityQueueElement &left, const FacilityQueueElement &right);
